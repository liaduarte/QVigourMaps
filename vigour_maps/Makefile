...
SOURCES = \
	__init__.py \
	vigour_maps.py vigour_maps_dialog.py

PLUGINNAME = vigour_maps

PY_FILES = \
	__init__.py \
	vigour_maps.py vigour_maps_dialog.py

UI_FILES = vigour_maps_dialog_base.ui
...
QGISDIR=C:\Users\Lia\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
